...
const AssistenteSaude = lazy(() => import("@/features/bem-estar/pages/AssistenteSaude"));
...
// Playlist Musical
const PlaylistMusical = lazy(() => import("@/features/playlist/pages/PlaylistMusical"));
  ...
  return (
    <AnimatePresence mode="wait">
      <Routes location={location} key={location.pathname}>
        ...
        <Route path="/playlist" element={<ProtectedRoute><LazyPage><PlaylistMusical /></LazyPage></ProtectedRoute>} />
        ...
        <Route path="/analise-progresso" element={<ProtectedRoute><LazyPage><AnaliseProgresso /></LazyPage></ProtectedRoute>} />
