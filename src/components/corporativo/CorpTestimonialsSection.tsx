      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <h2 className="text-3xl lg:text-4xl font-bold text-foreground">
            O que dizem os{" "}
            <span className="font-serif italic text-gradient">gestores de RH</span>
          </h2>
          <p className="mt-4 text-muted-foreground">
            Profissionais de recursos humanos compartilham suas experiências com nossos programas corporativos.
          </p>
        </motion.div>
