...
export const HeadSpaSection = () => {
  return (
    <section className="py-14 sm:py-20 lg:py-28 px-5 sm:px-6 lg:px-8 bg-primary/5 relative overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-14 items-center">
          ...
          >
            ...
            <p className="text-muted-foreground leading-relaxed mb-6">
              Um ritual de beleza que vai além do cuidado capilar. Combinando limpeza profunda, 
              massagens terapêuticas e aromaterapia, cada sessão de 60 a 90 minutos promove 
              saúde, relaxamento e bem-estar holístico.
            </p>
