...
import { Home, CalendarDays, ShoppingBag, User, Gift, Wallet, Crown, Settings, Bell, Dumbbell, Activity, BookOpen, Scan, Apple, Globe, Ticket, Handshake, GraduationCap, Flower2 } from "lucide-react";
...
const navItems = [
  ...
  { icon: GraduationCap, label: "Curso de Vendas", path: "/curso-vendas" },
  { icon: Flower2, label: "Curso Aromaterapia", path: "/curso-aromaterapia" },
];
