...
import { useProdutos, usePedidos, Produto } from "@/features/loja/hooks/usePedidos";
import { useTransacoes } from "@/features/cashback/hooks/useTransacoes";
import { Tabs, TabsContent, TabsList, TabsTrigger } from "@/components/ui/tabs";
import { format } from "date-fns";
import { ptBR } from "date-fns/locale";
import { ProdutoCard } from "@/features/loja/components/ProdutoCard";
import { CarrinhoFlutuante } from "@/features/loja/components/CarrinhoFlutuante";
import { CarrinhoSheet } from "@/features/loja/components/CarrinhoSheet";
...
export default function Loja() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case "entregue": return "bg-highlight/20 text-highlight";
            ...
            <Tabs value={activeTab} onValueChange={setActiveTab}>
              ...
              <TabsContent value="pedidos" className="mt-4">
                {loadingPedidos ? (
                  ...
                  >
                    {pedidos.map((pedido) => (
                      <motion.div key={pedido.id} variants={fadeUp}>
