        ...
        <div className="max-w-lg lg:max-w-4xl mx-auto px-4 lg:px-8 py-6">
          ...
          >
            ...
            <motion.div variants={fadeUp} className="space-y-2.5">
              <Label htmlFor="email" className="section-label">Email do destinatário</Label>
              <div className="flex gap-2">
                <Input
                  ...
                  value={email}
                  onChange={(e) => { setEmail(e.target.value); setDestinatario(null); }}
                  className="flex-1"
                />
                <Button variant="secondary" onClick={buscarUsuario} disabled={buscando}>
            ...
            {destinatario && (
              <motion.div
                ...
                className="p-4 rounded-2xl glass-card-strong border-primary/20"
              >
            ...
            {destinatario && (
              ...
              >
                <Label htmlFor="valor" className="section-label">Valor da transferência</Label>
            ...
            {destinatario && valor && (
              ...
              >
                ...
                >
                  {transferindo ? <ButtonLoader /> : <><Send className="w-5 h-5" /> Transferir</>}
                </Button>
              </motion.div>
            )}
          </motion.div>
